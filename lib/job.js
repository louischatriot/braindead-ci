...
var config = require('./config')
  ...
  , jobsDb   // Database that'll hold all jobs data. Initialized in app.js
  ;
...
var test = nStore.new('workspace/_data/test.db', function (err) {
  //console.log("LOADED");
  //console.log(err);

  //test.save('first', { hello: "world", cat: "Grafitti" }, function (err) {
    //console.log("============");
    //console.log(err);
  //});
//var test = nStore.new('workspace/_data/test.db');

  test.get("first", function (err, doc) {
    console.log("-----------");
    console.log(doc);
  });
});
