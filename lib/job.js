...
Job.getEditableProperties = function () {
  ...
  return ['name', 'branch', 'repoSSHUrl', 'githubRepoUrl'];
};
...
Job._edit.githubRepoUrl = function (newValue, callback) {
  self.githubRepoUrl = newValue;
  self.save(callback);
}
...
Job._edit.branch = function (newValue, callback) {
  self.branch = newValue;
  self.save(callback);
}
